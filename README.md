...
| Edit any API resource in your preferred editor.                                                                                      | kubectl edit {resource} *(Via CLI)*                                                   | Edit Jobs in Nomad UI                                                                                                                           | Execute a command in a container                                                                                             | kubectl exec                                                           | nomad alloc exec                                                                                                                                                                            | 
